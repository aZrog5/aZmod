...
public class AzmodeModItems {
	...
	public static final RegistryObject<Item> WONG_SPAWN_EGG = REGISTRY.register("wong_spawn_egg", () -> new ForgeSpawnEggItem(AzmodeModEntities.WONG, -13434880, -1, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
	public static final RegistryObject<Item> MEZZ_SPAWN_EGG = REGISTRY.register("mezz_spawn_egg", () -> new ForgeSpawnEggItem(AzmodeModEntities.MEZZ, -16711732, -3355648, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
	public static final RegistryObject<Item> WONG_2_SPAWN_EGG = REGISTRY.register("wong_2_spawn_egg", () -> new ForgeSpawnEggItem(AzmodeModEntities.WONG_2, -1, -13434880, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
	public static final RegistryObject<Item> MEZZ_2_SPAWN_EGG = REGISTRY.register("mezz_2_spawn_egg", () -> new ForgeSpawnEggItem(AzmodeModEntities.MEZZ_2, -16711732, -205, new Item.Properties().tab(CreativeModeTab.TAB_MISC)));
