...
public class MezzEntity extends PathfinderMob implements IAnimatable {
	...
	public MezzEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AzmodeModEntities.MEZZ.get(), world);
	}

	public MezzEntity(EntityType<MezzEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "mezz");
	}
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 15) {
			this.remove(MezzEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
