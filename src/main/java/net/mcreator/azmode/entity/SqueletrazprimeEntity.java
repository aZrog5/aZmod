...
public class SqueletrazprimeEntity extends Monster implements IAnimatable {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(SqueletrazprimeEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(SqueletrazprimeEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(SqueletrazprimeEntity.class, EntityDataSerializers.STRING);
	...
	public SqueletrazprimeEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AzmodeModEntities.SQUELETRAZPRIME.get(), world);
	}

	public SqueletrazprimeEntity(EntityType<SqueletrazprimeEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "squeletraz_prime");
	}
	...
	public static void init() {
		SpawnPlacements.register(AzmodeModEntities.SQUELETRAZPRIME.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 15) {
			this.remove(SqueletrazprimeEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
