...
public class ScytheEntity extends Bat implements IAnimatable {
	...
	public ScytheEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AzmodeModEntities.SCYTHE.get(), world);
	}

	public ScytheEntity(EntityType<ScytheEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "squeletrazprimescythe");
	}
	...
	public static void init() {
		SpawnPlacements.register(AzmodeModEntities.SCYTHE.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 15) {
			this.remove(ScytheEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
