...
public class TanuzEntity extends Zombie implements IAnimatable {
	public static final EntityDataAccessor<Boolean> SHOOT = SynchedEntityData.defineId(TanuzEntity.class, EntityDataSerializers.BOOLEAN);
	public static final EntityDataAccessor<String> ANIMATION = SynchedEntityData.defineId(TanuzEntity.class, EntityDataSerializers.STRING);
	public static final EntityDataAccessor<String> TEXTURE = SynchedEntityData.defineId(TanuzEntity.class, EntityDataSerializers.STRING);
	...
	public TanuzEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(AzmodeModEntities.TANUZ.get(), world);
	}

	public TanuzEntity(EntityType<TanuzEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
		setPersistenceRequired();
		this.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack(AzmodeModItems.HOLYSWORD.get()));
		this.setItemSlot(EquipmentSlot.OFFHAND, new ItemStack(Blocks.RED_CANDLE));
	}
	...
	protected void defineSynchedData() {
		...
		this.entityData.define(TEXTURE, "tanuz");
	}
	...
	protected void tickDeath() {
		...
		if (this.deathTime == 15) {
			this.remove(TanuzEntity.RemovalReason.KILLED);
			this.dropExperience();
		}
	}
